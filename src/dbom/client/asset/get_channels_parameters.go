...
// WithRepoID adds the repoID to the get channels params
func (o *GetChannelsParams) WithRepoID(repoID string) *GetChannelsParams {
	o.SetRepoID(repoID)
	return o
}

// SetRepoID adds the repoId to the get channels params
func (o *GetChannelsParams) SetRepoID(repoID string) {
	o.RepoID = repoID
}
